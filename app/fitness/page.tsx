...
export default function FitnessPage() {
  const whatsappHref = `https://wa.me/919113914154?text=${encodeURIComponent("Hey, I saw your fitness app page and I am interested in launching a branded app for my audience. Can we talk?")}`;

  return (
    <div className="bg-[#080B14] text-white overflow-x-hidden">
      <main>

        <FitnessHero videoId="sULrktkZ8lU" thumbnail="/fitness-thumbnail.png" whatsappHref={whatsappHref} />
          ...
          <div className="mx-auto max-w-6xl">
            <div className="text-center">
              ...
              <p className="mx-auto mt-5 max-w-3xl text-base font-medium text-[#94A3B8] md:text-lg">
                This demo is gym-heavy, but your version is shaped to your niche, your audience behavior, and your coaching method.
              </p>
            </div>
        ...
        <section className="px-6 py-16 md:px-10">
          ...
          >
            <p
              className="text-2xl font-black leading-tight tracking-tight md:text-3xl lg:text-4xl"
        ...
        <section className="px-6 py-16 md:px-10">
          <div className="mx-auto max-w-5xl text-center">
            <p className="text-4xl font-black leading-tight tracking-tight md:text-6xl lg:text-7xl">
              ...
              <span
                className="bg-clip-text text-transparent"
                style={{ backgroundImage: 'linear-gradient(135deg, #A78BFA 0%, #22C55E 100%)' }}
              >
          ...
          >
            ...
            <div className="mx-auto mt-8 max-w-2xl space-y-3 text-center">
              {[
                ...
                <p key={i} className="text-base font-semibold text-[#CBD5E1]">
                  {t}
                </p>
              ))}
            </div>
